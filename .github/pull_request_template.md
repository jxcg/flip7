...
- Method (`Red/green`, `Refactor`, or `N/A`; explain if not red/green and omit inapplicable fields):
...
- Clean-worktree focused command; selected test/count and result on red and green; exit statuses:
